...
class PromptPptxBuilder:
    ...
    def create_prompt(self) -> List[Dict[str, str]]:
        ...
        prompts = [{
            "role": "system",
            "content": f"you are a helpful AI that is explaining a PowerPoint presentation."
        }]
        slides = "".join([slide[0]+slide[1] + slide[2] for slide in self.slide_content])
