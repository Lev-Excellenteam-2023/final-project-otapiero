...
def process_pptx_file_content(pptx_file_content: list[list[str,str,str]])->list[list[str]]:
    ...
    :param
        pptx_file_content: list of lists, each list contains title, text and notes of a slide
    :return:
        list of lists, each list contains title, text and notes of a slide as one string
    '''
