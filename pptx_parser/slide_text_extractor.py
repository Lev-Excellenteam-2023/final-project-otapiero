'''
 this module is used to extract text from pptx file
'''
import pptx
...
def get_pptx_file_content ( pptx_file_path: str ) -> list[list[str]]:
    ...
    :param
        pptx_file: pptx file object
    :return:
        list of lists, each list contains title, text and notes of a slide
    '''
